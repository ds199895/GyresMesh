 ...
 * */
    ...
    public void displayHeMeshWithDegree(GE_Mesh mesh, double distance)
    {
      ...
      Color colorless = Color.FromArgb(250, 250, 240);
      Color color5 = Color.FromArgb(250, 240, 240);
      Color color6 = Color.FromArgb(240, 230, 230);
      Color color7 = Color.FromArgb(230, 220, 240);
      Color colormore = Color.FromArgb(245, 235, 253);
      //        displayHeFaces(mesh,color6);
    ...
    public void displayHeFacesWithDegree(GE_Mesh mesh)
    {
      ...
      Color colorless = Color.FromArgb(250, 250, 240);
      Color color5 = Color.FromArgb(250, 240, 240);
      Color color6 = Color.FromArgb(235, 253, 240);
      Color color7 = Color.FromArgb(190, 220, 240);
      Color colormore = Color.FromArgb(180, 200, 253);
    ...
    public void displayHeVerticesWithDegree(GE_Mesh mesh, double distance)
    {
      ...
      home.PushStyle();
      Color colorless = Color.FromArgb(251, 199, 190);
      Color color5 = Color.FromArgb(249, 100, 100);
      Color color6 = Color.FromArgb(205, 237, 159);
      Color color7 = Color.FromArgb(95, 178, 199);
      Color colormore = Color.FromArgb(166, 149, 223);
    ...
    public void displayHeVertices(GE_Mesh mesh)
    {
      ...
      home.PushStyle();
      Color color = Color.FromArgb(205, 237, 159);
    ...
    {
      home.PushStyle();
      Color color = Color.FromArgb(95, 178, 199);
